...
p <- ggplot() +
      ...
      scale_y_continuous(trans='log10') +
      annotation_logticks(sides = "l") +
      annotate("text", x = 1.7, y = 7, label = "ANOVA; R2=0.27,\n population*water mass F[6,123]=5.75, p=0.004")
p

pdf("growth rate interaction_mean and CI.pdf", height=5, width=7) ; plot(p) ; dev.off()


```

default is ST, and SYN. SA is lower than ST. 
in SA, 
