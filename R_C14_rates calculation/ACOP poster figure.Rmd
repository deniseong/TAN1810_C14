...
# pp rates per cell
```{r}
pp_rates <- readxl::read_excel("C14_rates per group_method2.xlsx")  %>%
...
pdf("figures/ACOP_figures/pp_rates_group.pdf", height=4, width=6) ; plot(p3) ; dev.off()
...
p6
pdf("figures/ACOP_figures/pp_total.pdf", height=4, width=6) ; plot(p6) ; dev.off()
