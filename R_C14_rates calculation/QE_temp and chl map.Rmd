...
plot_temp<- ggplot() +
  ...
  scale_fill_gradientn(colours=rev(brewer.pal(20,"RdBu")))
  scale_fill_manual(values = colorRampPalette(rev(brewer.pal(10,"RdBu"))))

plot_temp

pdf("figures/GRC_figures/map_temp.pdf", height=4, width=6) ; plot(plot_temp) ; dev.off()
...
pdf("figures/GRC_figures/map_stations.pdf", height=4, width=6) ; plot(p) ; dev.off()
```
