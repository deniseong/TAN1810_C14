...
ps_18s_filt<- read_rds("output_18SV4/TAN1810_18SV4phyloseq_CTD_18SV4.RDS") 

#copy the column of interest to create new column, and replacing names for water masses SA and ST
sample_data(ps_18s_filt)$water_mass <- sample_data(ps_18s_filt)$cycle
sample_data(ps_18s_filt)$water_mass = str_replace(sample_data(ps_18s_filt)$water_mass, "1|2|5", "SA") 
sample_data(ps_18s_filt)$water_mass = str_replace(sample_data(ps_18s_filt)$water_mass, "3|4", "ST")
...
sample_data(ps_18s_filt)$cycle_location_name <- str_c(sample_data(ps_18s_filt)$cycle_location, sample_data(ps_18s_filt)$cycle_name, sep ="_")
...
# Do normalizations and transformation
ps_18s_filt <- phyloseq_normalize_median(ps_18s_filt)
long_18s_filt <- phyloseq_transform_to_long(ps_18s_filt)
```
