...
sample_data(ps_nano)$water_mass = str_replace(sample_data(ps_nano)$water_mass, "1|2|5", "SA") 
sample_data(ps_nano)$water_mass = str_replace(sample_data(ps_nano)$water_mass, "3|4", "ST")

#copy the column of interest, creating new column and replace for cycle names. Not using this column for now. 
sample_data(ps_nano)$cycle_location <- sample_data(ps_nano)$Cycle#
sample_data(ps_nano)$cycle_location = str_replace(sample_data(ps_nano)$cycle_location, "1", "C")
sample_data(ps_nano)$cycle_location = str_replace(sample_data(ps_nano)$cycle_location, "2", "D") 
sample_data(ps_nano)$cycle_location = str_replace(sample_data(ps_nano)$cycle_location, "5", "E") 
sample_data(ps_nano)$cycle_location = str_replace(sample_data(ps_nano)$cycle_location, "3", "A")
sample_data(ps_nano)$cycle_location = str_replace(sample_data(ps_nano)$cycle_location, "4", "B")

sample_data(ps_nano)$cycle_name <- sample_data(ps_nano)$Cycle#
sample_data(ps_nano)$cycle_name = str_replace(sample_data(ps_nano)$cycle_name, "1", "SA-Cycle_1")
sample_data(ps_nano)$cycle_name = str_replace(sample_data(ps_nano)$cycle_name, "2", "SA-Cycle_2") 
sample_data(ps_nano)$cycle_name = str_replace(sample_data(ps_nano)$cycle_name, "5", "SA-Cycle_5") 
sample_data(ps_nano)$cycle_name = str_replace(sample_data(ps_nano)$cycle_name, "3", "ST-Cycle_3")
sample_data(ps_nano)$cycle_name = str_replace(sample_data(ps_nano)$cycle_name, "4", "ST-Cycle_4")

sample_data(ps_nano)$cycle_location_name <- str_c(sample_data(ps_nano)$cycle_location, sample_data(ps_nano)$cycle_name, sep ="_")
...
sample_data(ps_nano)$vial_type = str_replace(sample_data(ps_nano)$vial_type, "A|B|C", "light")
sample_data(ps_nano)$vial_type = str_replace(sample_data(ps_nano)$vial_type, "D", "dark")

junk <- data.frame(ps_nano@sam_data)
