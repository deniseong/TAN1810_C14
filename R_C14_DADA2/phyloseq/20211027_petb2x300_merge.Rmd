...
```{r}
# Load the phyloseq files
ps_ctd_normal_R2 <- read_rds("output_petb_2x300/output_petb_Mazard/merged_v2/petB Mazard primer_phyloseq_CTD.RDS")  # adding new component, this case the phyloseq object to the "tag" all
