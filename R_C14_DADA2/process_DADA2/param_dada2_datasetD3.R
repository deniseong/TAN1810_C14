...
# Need to change
dataset_code <- "TAN1810_petB_normal"
dataset_id <- "D3"
...
# Need to change
# primer sets (petB-F TACGACTGGTTCCAGGAACG petB-R GAAGTGCATGAGCATGAA)
...
# For normal petB, the length of the sequence with the primer is 594bp. after filter and trim there is no more overlapping region so cannot merge.
