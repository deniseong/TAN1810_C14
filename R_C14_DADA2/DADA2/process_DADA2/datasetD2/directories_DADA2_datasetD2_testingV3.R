...
dir_fastqN <-  "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_Denise_testing/testing_v3/fastqN/"  # for filtered files removing reads with N
dir_cutadapt <- "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_Denise_testing/testing_v3/cutadapt/" # files after cutadapt
dir_filtered<- "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_Denise_testing/testing_v3/filtered/"  # fastq filtered
...
dir_qual <- "output_petb_2x300/output_petb_Denise_testing/testing_v3/qual_pdf/"  # qual pdf
...
output_path <- function(file_end)  str_c("output_petb_2x300/output_petb_Denise_testing/testing_v3/", dataset_code, file_end)
