# The directories listed is for petB F/R, R1.

dir_fastq <- "/Volumes/Denise/C14_DADA2/fastq_petb_2x300/fastq_petb_F-R"  # fastq directory

# set output to harddrive
dir_fastqN <-  "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_F-R/R1/fastqN/"  # for filtered files removing reads with N
dir_cutadapt <- "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_F-R/R1/cutadapt/" # files after cutadapt
dir_filtered<- "/Volumes/Denise/C14_DADA2/output_petb_2x300/output_petb_F-R/R1/filtered/"  # fastq filtered

# set output to github
dir_qual <- "output_petb_2x300/output_petb_F-R/R1/qual_pdf/"  # qual pdf
...
output_path <- function(file_end)  str_c("output_petb_2x300/output_petb_F-R/R1/", dataset_code, file_end)
