...
getPalette = colorRampPalette(c(brewer.pal(12, "Paired"), brewer.pal(8, "Set1"))) 
...
classList = rbind(unique(tax_table(ps_filt_sort)[,"class"]), "Others")
