...
seq_hash <- readxl::read_excel(here("DADA2", "output_18SV4", "TAN1810_18SV4_metapr2_asv.xlsx")) %>%
...
junk <-  data.frame(ps_sort_filt@sam_data)

saveRDS(ps_sort_filt, here("DADA2", "merge_filt_phyloseq", "phyloseq_merge_asv_set_47_Eukaryota_D4_filt_sort_seqhash.RDS"))
