...
•	Exp 6: SUR: vial C, error in recording. Changed in excel sheet
...
```{r}
C14_DPM <- readxl::read_excel("TAN1810_14C-Pico_25052020_QA_1.0.xlsx", sheet = "Complete data TAN1810", skip = 11) %>%
...
•	exp 5: SUR. Vial D is high. Also marked in the excel sheet. Removed, to be checked
• exp 2: DCM. cells sorted for vial A is 496. 
